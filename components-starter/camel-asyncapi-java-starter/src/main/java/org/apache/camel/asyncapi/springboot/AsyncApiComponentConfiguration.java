...
@ConfigurationProperties(prefix = "camel.component.async-api")
public class AsyncApiComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the async-api component. This is
     * enabled by default.
     */
    private Boolean enabled;
    /**
     * todo The Camel Rest component to use for (consumer) the REST transport,
